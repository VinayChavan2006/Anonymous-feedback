...
import { Loader, Loader2, LoaderPinwheel, RefreshCcw } from "lucide-react";
...
const Dashboard = () => {
  ...
  const fetchMessages = useCallback(
    ...
    [ setMessages, setIsFetchingMessages, toast]
  );
  ...
  useEffect(() => {
    ...
    fetchSwitchState();
    fetchMessages();
  }, [session, setValue, fetchMessages, fetchSwitchState,toast]);
  ...
  if(status === 'loading'){
    return (
      <div className="flex justify-center items-center w-full h-screen">
        <LoaderPinwheel className="w-16 h-16 animate-spin"/>
      </div>
    )
  }
